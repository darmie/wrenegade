...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("OpenflSample", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("OpenflSample", null, 800, 600);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "OpenflSample";
		app.meta["name"] = "OpenflSample";
		app.meta["packageName"] = "com.sample.openflsample";
