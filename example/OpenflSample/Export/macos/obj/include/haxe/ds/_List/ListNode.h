...
HX_DECLARE_STACK_FRAME(_hx_pos_d7fe8fcac3c6136e_263_new)
...
class HXCPP_CLASS_ATTRIBUTES ListNode_obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< ListNode_obj > __new( ::Dynamic item, ::haxe::ds::_List::ListNode next) {
			hx::ObjectPtr< ListNode_obj > __this = new ListNode_obj();
			__this->__construct(item,next);
			return __this;
		}

		static hx::ObjectPtr< ListNode_obj > __alloc(hx::Ctx *_hx_ctx, ::Dynamic item, ::haxe::ds::_List::ListNode next) {
...
{
            	HX_STACKFRAME(&_hx_pos_d7fe8fcac3c6136e_263_new)
HXLINE( 264)		( ( ::haxe::ds::_List::ListNode)(__this) )->item = item;
HXLINE( 265)		( ( ::haxe::ds::_List::ListNode)(__this) )->next = next;
            	}
