...
HX_DEFINE_STACK_FRAME(_hx_pos_d7fe8fcac3c6136e_263_new,"haxe.ds._List.ListNode","new",0x5847787a,"haxe.ds._List.ListNode.new","/usr/local/lib/haxe/std/haxe/ds/List.hx",263,0x54f95eac)
namespace haxe{
namespace ds{
namespace _List{
...
HXLINE( 264)		this->item = item;
HXLINE( 265)		this->next = next;
            	}
