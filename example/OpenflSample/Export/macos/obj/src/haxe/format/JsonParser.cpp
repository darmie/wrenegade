...
HX_LOCAL_STACK_FRAME(_hx_pos_325103750a35722e_264_invalidChar,"haxe.format.JsonParser","invalidChar",0xa9f373d5,"haxe.format.JsonParser.invalidChar","/usr/local/lib/haxe/std/haxe/format/JsonParser.hx",264,0x4a8b222b)
HX_LOCAL_STACK_FRAME(_hx_pos_325103750a35722e_270_invalidNumber,"haxe.format.JsonParser","invalidNumber",0x8e9d1988,"haxe.format.JsonParser.invalidNumber","/usr/local/lib/haxe/std/haxe/format/JsonParser.hx",270,0x4a8b222b)
namespace haxe{
namespace format{
...
HXLINE( 156)			int c = this->str.cca(this->pos++);
HXLINE( 157)			if ((c == 34)) {
HXLINE( 158)				goto _hx_goto_8;
            			}
HXLINE( 159)			if ((c == 92)) {
HXLINE( 160)				if (hx::IsNull( buf )) {
HXLINE( 161)					buf =  ::StringBuf_obj::__alloc( HX_CTX );
            				}
HXLINE( 163)				{
HXLINE( 163)					::String s = this->str;
HXDLIN( 163)					 ::Dynamic len = ((this->pos - start) - 1);
HXDLIN( 163)					if (hx::IsNotNull( buf->charBuf )) {
HXLINE( 163)						buf->flush();
            					}
HXDLIN( 163)					if (hx::IsNull( buf->b )) {
HXLINE( 163)						buf->b = ::Array_obj< ::String >::__new(1)->init(0,s.substr(start,len));
            					}
            					else {
HXLINE( 163)						::Array< ::String > buf1 = buf->b;
HXDLIN( 163)						buf1->push(s.substr(start,len));
            					}
            				}
HXLINE( 164)				c = this->str.cca(this->pos++);
HXLINE( 165)				switch((int)(c)){
            					case (int)34: case (int)47: case (int)92: {
HXLINE( 171)						if (hx::IsNull( buf->charBuf )) {
HXLINE( 171)							buf->charBuf = ::Array_obj< char >::__new();
            						}
HXDLIN( 171)						buf->charBuf->push(c);
            					}
            					break;
            					case (int)98: {
...
HXDLIN( 170)						buf->charBuf->push(12);
            					}
            					break;
            					case (int)110: {
...
HXDLIN( 167)						buf->charBuf->push(10);
            					}
            					break;
            					case (int)114: {
...
HXDLIN( 166)						buf->charBuf->push(13);
            					}
            					break;
            					case (int)116: {
...
HXDLIN( 168)						buf->charBuf->push(9);
            					}
            					break;
            					case (int)117: {
HXLINE( 173)						 ::Dynamic uc = ::Std_obj::parseInt((HX_("0x",48,2a,00,00) + this->str.substr(this->pos,4)));
HXLINE( 174)						 ::haxe::format::JsonParser _hx_tmp = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 174)						_hx_tmp->pos = (_hx_tmp->pos + 4);
HXLINE( 176)						if (hx::IsLessEq( uc,127 )) {
HXLINE( 177)							if (hx::IsNull( buf->charBuf )) {
HXLINE( 177)								buf->charBuf = ::Array_obj< char >::__new();
            							}
HXDLIN( 177)							buf->charBuf->push(( (int)(uc) ));
            						}
            						else {
HXLINE( 178)							if (hx::IsLessEq( uc,2047 )) {
HXLINE( 179)								{
HXLINE( 179)									if (hx::IsNull( buf->charBuf )) {
HXLINE( 179)										buf->charBuf = ::Array_obj< char >::__new();
            									}
HXDLIN( 179)									buf->charBuf->push((192 | (( (int)(uc) ) >> 6)));
            								}
HXLINE( 180)								{
HXLINE( 180)									if (hx::IsNull( buf->charBuf )) {
HXLINE( 180)										buf->charBuf = ::Array_obj< char >::__new();
            									}
HXDLIN( 180)									buf->charBuf->push((128 | (( (int)(uc) ) & 63)));
            								}
            							}
            							else {
HXLINE( 181)								if (hx::IsLessEq( uc,65535 )) {
HXLINE( 182)									{
HXLINE( 182)										if (hx::IsNull( buf->charBuf )) {
HXLINE( 182)											buf->charBuf = ::Array_obj< char >::__new();
            										}
HXDLIN( 182)										buf->charBuf->push((224 | (( (int)(uc) ) >> 12)));
            									}
HXLINE( 183)									{
HXLINE( 183)										if (hx::IsNull( buf->charBuf )) {
HXLINE( 183)											buf->charBuf = ::Array_obj< char >::__new();
            										}
HXDLIN( 183)										buf->charBuf->push((128 | ((( (int)(uc) ) >> 6) & 63)));
            									}
HXLINE( 184)									{
HXLINE( 184)										if (hx::IsNull( buf->charBuf )) {
HXLINE( 184)											buf->charBuf = ::Array_obj< char >::__new();
            										}
HXDLIN( 184)										buf->charBuf->push((128 | (( (int)(uc) ) & 63)));
            									}
            								}
            								else {
HXLINE( 186)									{
HXLINE( 186)										if (hx::IsNull( buf->charBuf )) {
HXLINE( 186)											buf->charBuf = ::Array_obj< char >::__new();
            										}
HXDLIN( 186)										buf->charBuf->push((240 | (( (int)(uc) ) >> 18)));
            									}
HXLINE( 187)									{
HXLINE( 187)										if (hx::IsNull( buf->charBuf )) {
HXLINE( 187)											buf->charBuf = ::Array_obj< char >::__new();
            										}
HXDLIN( 187)										buf->charBuf->push((128 | ((( (int)(uc) ) >> 12) & 63)));
            									}
HXLINE( 188)									{
HXLINE( 188)										if (hx::IsNull( buf->charBuf )) {
HXLINE( 188)											buf->charBuf = ::Array_obj< char >::__new();
            										}
HXDLIN( 188)										buf->charBuf->push((128 | ((( (int)(uc) ) >> 6) & 63)));
            									}
HXLINE( 189)									{
HXLINE( 189)										if (hx::IsNull( buf->charBuf )) {
HXLINE( 189)											buf->charBuf = ::Array_obj< char >::__new();
            										}
HXDLIN( 189)										buf->charBuf->push((128 | (( (int)(uc) ) & 63)));
            									}
            								}
            							}
            						}
            					...
            					break;
            					default:{
HXLINE( 195)						HX_STACK_DO_THROW((((HX_("Invalid escape sequence \\",73,af,f7,b2) + ::String::fromCharCode(c)) + HX_(" at position ",0a,c2,01,e0)) + (this->pos - 1)));
            					}
            				}
HXLINE( 197)				start = this->pos;
            			}
            			else {
HXLINE( 201)				if ((c >= 128)) {
HXLINE( 202)					this->pos++;
HXLINE( 203)					if ((c >= 252)) {
HXLINE( 203)						 ::haxe::format::JsonParser _hx_tmp1 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 203)						_hx_tmp1->pos = (_hx_tmp1->pos + 4);
            					}
            					else {
HXLINE( 204)						if ((c >= 248)) {
HXLINE( 204)							 ::haxe::format::JsonParser _hx_tmp2 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 204)							_hx_tmp2->pos = (_hx_tmp2->pos + 3);
            						}
            						else {
HXLINE( 205)							if ((c >= 240)) {
HXLINE( 205)								 ::haxe::format::JsonParser _hx_tmp3 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 205)								_hx_tmp3->pos = (_hx_tmp3->pos + 2);
            							}
            							else {
HXLINE( 206)								if ((c >= 224)) {
HXLINE( 206)									this->pos++;
...
HXLINE( 209)					if ((c == 0)) {
HXLINE( 210)						HX_STACK_DO_THROW(HX_("Unclosed string",ac,02,ef,ea));
            					}
            				}
            			}
            		}
            		_hx_goto_8:;
HXLINE( 212)		if (hx::IsNull( buf )) {
HXLINE( 213)			return this->str.substr(start,((this->pos - start) - 1));
            		}
            		else {
HXLINE( 216)			{
HXLINE( 216)				::String s1 = this->str;
HXDLIN( 216)				 ::Dynamic len1 = ((this->pos - start) - 1);
HXDLIN( 216)				if (hx::IsNotNull( buf->charBuf )) {
HXLINE( 216)					buf->flush();
            				}
HXDLIN( 216)				if (hx::IsNull( buf->b )) {
HXLINE( 216)					buf->b = ::Array_obj< ::String >::__new(1)->init(0,s1.substr(start,len1));
            				}
            				else {
HXLINE( 216)					::Array< ::String > buf2 = buf->b;
HXDLIN( 216)					buf2->push(s1.substr(start,len1));
            				}
            			}
HXLINE( 217)			return buf->toString();
            		}
...
void JsonParser_obj::invalidChar(){
            	HX_STACKFRAME(&_hx_pos_325103750a35722e_264_invalidChar)
HXLINE( 265)		this->pos--;
HXLINE( 266)		::String _hx_tmp = ((HX_("Invalid char ",81,66,ec,29) + this->str.cca(this->pos)) + HX_(" at position ",0a,c2,01,e0));
HXDLIN( 266)		HX_STACK_DO_THROW((_hx_tmp + this->pos));
            	}
...
void JsonParser_obj::invalidNumber(int start){
            	HX_STACKFRAME(&_hx_pos_325103750a35722e_270_invalidNumber)
HXDLIN( 270)		HX_STACK_DO_THROW((((HX_("Invalid number at position ",d8,9d,6f,13) + start) + HX_(": ",a6,32,00,00)) + this->str.substr(start,(this->pos - start))));
            	}
