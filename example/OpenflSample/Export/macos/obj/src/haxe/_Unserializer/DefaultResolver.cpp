...
HX_DEFINE_STACK_FRAME(_hx_pos_68dfa52f787219bb_478_new,"haxe._Unserializer.DefaultResolver","new",0xe2809ead,"haxe._Unserializer.DefaultResolver.new","/usr/local/lib/haxe/std/haxe/Unserializer.hx",478,0x60de4a67)
HX_LOCAL_STACK_FRAME(_hx_pos_68dfa52f787219bb_479_resolveClass,"haxe._Unserializer.DefaultResolver","resolveClass",0xbc0d3dbf,"haxe._Unserializer.DefaultResolver.resolveClass","/usr/local/lib/haxe/std/haxe/Unserializer.hx",479,0x60de4a67)
...
void DefaultResolver_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_68dfa52f787219bb_478_new)
            	}
...
hx::Class DefaultResolver_obj::resolveClass(::String name){
            	HX_STACKFRAME(&_hx_pos_68dfa52f787219bb_479_resolveClass)
