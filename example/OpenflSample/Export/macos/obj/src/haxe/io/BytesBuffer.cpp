...
HX_DEFINE_STACK_FRAME(_hx_pos_20ad791bf00c982a_50_new,"haxe.io.BytesBuffer","new",0x022790dd,"haxe.io.BytesBuffer.new","/usr/local/lib/haxe/std/haxe/io/BytesBuffer.hx",50,0xad7eed50)
HX_LOCAL_STACK_FRAME(_hx_pos_20ad791bf00c982a_181_getBytes,"haxe.io.BytesBuffer","getBytes",0x1e9f7258,"haxe.io.BytesBuffer.getBytes","/usr/local/lib/haxe/std/haxe/io/BytesBuffer.hx",181,0xad7eed50)
namespace haxe{
namespace io{

void BytesBuffer_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_20ad791bf00c982a_50_new)
...
bool BytesBuffer_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::io::Bytes BytesBuffer_obj::getBytes(){
            	HX_GC_STACKFRAME(&_hx_pos_20ad791bf00c982a_181_getBytes)
