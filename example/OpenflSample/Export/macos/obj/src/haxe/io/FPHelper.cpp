...
HX_LOCAL_STACK_FRAME(_hx_pos_754a83c1cbcee281_149_i32ToFloat,"haxe.io.FPHelper","i32ToFloat",0x7999b6cf,"haxe.io.FPHelper.i32ToFloat","/usr/local/lib/haxe/std/haxe/io/FPHelper.hx",149,0x3a3d79e9)
HX_LOCAL_STACK_FRAME(_hx_pos_754a83c1cbcee281_186_floatToI32,"haxe.io.FPHelper","floatToI32",0xff5a7c67,"haxe.io.FPHelper.floatToI32","/usr/local/lib/haxe/std/haxe/io/FPHelper.hx",186,0x3a3d79e9)
HX_LOCAL_STACK_FRAME(_hx_pos_754a83c1cbcee281_232_i64ToDouble,"haxe.io.FPHelper","i64ToDouble",0xc51d801d,"haxe.io.FPHelper.i64ToDouble","/usr/local/lib/haxe/std/haxe/io/FPHelper.hx",232,0x3a3d79e9)
HX_LOCAL_STACK_FRAME(_hx_pos_754a83c1cbcee281_296_doubleToI64,"haxe.io.FPHelper","doubleToI64",0xe6926a85,"haxe.io.FPHelper.doubleToI64","/usr/local/lib/haxe/std/haxe/io/FPHelper.hx",296,0x3a3d79e9)
namespace haxe{
namespace io{
...
Float FPHelper_obj::i32ToFloat(int i){
            	HX_STACKFRAME(&_hx_pos_754a83c1cbcee281_149_i32ToFloat)
HXDLIN( 149)		return  ::__hxcpp_reinterpret_le_int32_as_float32(i);
            	}
...
int FPHelper_obj::floatToI32(Float f){
            	HX_STACKFRAME(&_hx_pos_754a83c1cbcee281_186_floatToI32)
...
Float FPHelper_obj::i64ToDouble(int low,int high){
            	HX_STACKFRAME(&_hx_pos_754a83c1cbcee281_232_i64ToDouble)
HXDLIN( 232)		return  ::__hxcpp_reinterpret_le_int32s_as_float64(low,high);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(FPHelper_obj,i64ToDouble,return )
 ...
 cpp::Int64Struct FPHelper_obj::doubleToI64(Float v){
            	HX_STACKFRAME(&_hx_pos_754a83c1cbcee281_296_doubleToI64)
HXDLIN( 296)		int high =  ::__hxcpp_reinterpret_float64_as_le_int32_high(v);
HXDLIN( 296)		return _hx_int64_make(high, ::__hxcpp_reinterpret_float64_as_le_int32_low(v));
            	}
