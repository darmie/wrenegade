...
HX_LOCAL_STACK_FRAME(_hx_pos_e2e0452d28e59cd7_30_instance,"Std","instance",0x1431f4e0,"Std.instance","/usr/local/lib/haxe/std/cpp/_std/Std.hx",30,0xe751091d)
HX_LOCAL_STACK_FRAME(_hx_pos_e2e0452d28e59cd7_34_string,"Std","string",0xcf48855c,"Std.string","/usr/local/lib/haxe/std/cpp/_std/Std.hx",34,0xe751091d)
HX_LOCAL_STACK_FRAME(_hx_pos_e2e0452d28e59cd7_38_int,"Std","int",0x8fa53b84,"Std.int","/usr/local/lib/haxe/std/cpp/_std/Std.hx",38,0xe751091d)
HX_LOCAL_STACK_FRAME(_hx_pos_e2e0452d28e59cd7_42_parseInt,"Std","parseInt",0x90c2ebc7,"Std.parseInt","/usr/local/lib/haxe/std/cpp/_std/Std.hx",42,0xe751091d)
HX_LOCAL_STACK_FRAME(_hx_pos_e2e0452d28e59cd7_46_parseFloat,"Std","parseFloat",0xbca10a74,"Std.parseFloat","/usr/local/lib/haxe/std/cpp/_std/Std.hx",46,0xe751091d)
HX_LOCAL_STACK_FRAME(_hx_pos_e2e0452d28e59cd7_49_random,"Std","random",0x75a77e8e,"Std.random","/usr/local/lib/haxe/std/cpp/_std/Std.hx",49,0xe751091d)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Std_obj,is,return )
 ...
 ::Dynamic Std_obj::instance( ::Dynamic value,hx::Class c){
            	HX_STACKFRAME(&_hx_pos_e2e0452d28e59cd7_30_instance)
...
::String Std_obj::string( ::Dynamic s){
            	HX_STACKFRAME(&_hx_pos_e2e0452d28e59cd7_34_string)
...
int Std_obj::_hx_int(Float x){
            	HX_STACKFRAME(&_hx_pos_e2e0452d28e59cd7_38_int)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Std_obj,_hx_int,return )
 ...
 ::Dynamic Std_obj::parseInt(::String x){
            	HX_STACKFRAME(&_hx_pos_e2e0452d28e59cd7_42_parseInt)
...
Float Std_obj::parseFloat(::String x){
            	HX_STACKFRAME(&_hx_pos_e2e0452d28e59cd7_46_parseFloat)
...
int Std_obj::random(int x){
            	HX_STACKFRAME(&_hx_pos_e2e0452d28e59cd7_49_random)
HXLINE(  50)		if ((x <= 0)) {
HXLINE(  50)			return 0;
            		}
