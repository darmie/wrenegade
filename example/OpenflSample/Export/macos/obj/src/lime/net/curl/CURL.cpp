...
HXLINE( 178)				bytes = ::haxe::io::Bytes_obj::alloc(0);
            			}
            			break;
            			case (int)20056: {
...
HXLINE( 215)		return ::lime::_internal::backend::native::NativeCFFI_obj::lime_curl_easy_setopt(hx::DynamicPtr(this->handle),option,hx::DynamicPtr(parameter),hx::DynamicPtr(bytes));
            	}
...
HXLINE( 224)		 ::hx::Object * result = ::lime::_internal::backend::native::NativeCFFI_obj::lime_curl_easy_strerror(code);
HXLINE( 228)		return ( ( ::Dynamic)(result) );
            	}
