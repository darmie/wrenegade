...
HXLINE(  54)		 ::lime::utils::ArrayBufferView this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,256,7);
...
HXDLIN(  58)					 ::__hxcpp_memory_set_ui32(this2->buffer->b,(this2->byteOffset + (i * 4)),val);
            				}
            			}
            		}
HXLINE(  61)		 ::lime::utils::ArrayBufferView this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,511,4);
HXDLIN(  61)		::lime::math::_RGBA::RGBA_Impl__obj::_hx___clamp = this3;
HXLINE(  63)		{
HXLINE(  63)			int _g1 = 0;
HXDLIN(  63)			while((_g1 < 255)){
HXLINE(  63)				_g1 = (_g1 + 1);
HXDLIN(  63)				int i1 = (_g1 - 1);
HXLINE(  65)				{
HXLINE(  65)					 ::lime::utils::ArrayBufferView this4 = ::lime::math::_RGBA::RGBA_Impl__obj::_hx___clamp;
HXDLIN(  65)					 ::__hxcpp_memory_set_byte(this4->buffer->b,(this4->byteOffset + i1),i1);
            				}
            			}
            		}
HXLINE(  68)		{
...
HXLINE(  68)				_g2 = (_g2 + 1);
HXDLIN(  68)				int i2 = (_g2 - 1);
HXLINE(  70)				{
HXLINE(  70)					 ::lime::utils::ArrayBufferView this5 = ::lime::math::_RGBA::RGBA_Impl__obj::_hx___clamp;
HXDLIN(  70)					 ::__hxcpp_memory_set_byte(this5->buffer->b,(this5->byteOffset + i2),255);
            				}
            			}
            		}
            	}
...
HXDLIN( 157)				this1 = (((((r & 255) << 24) | ((g & 255) << 16)) | ((b & 255) << 8)) | (( (int)(( ::__hxcpp_memory_get_byte(data->buffer->b,(data->byteOffset + (offset + 3))) & 255)) ) & 255));
            			...
            			break;
            			case (int)1: {
HXLINE( 160)				int r1 = ( (int)(( ::__hxcpp_memory_get_byte(data->buffer->b,(data->byteOffset + (offset + 1))) & 255)) );
HXDLIN( 160)				int g1 = ( (int)(( ::__hxcpp_memory_get_byte(data->buffer->b,(data->byteOffset + (offset + 2))) & 255)) );
HXDLIN( 160)				int b1 = ( (int)(( ::__hxcpp_memory_get_byte(data->buffer->b,(data->byteOffset + (offset + 3))) & 255)) );
HXDLIN( 160)				this1 = (((((r1 & 255) << 24) | ((g1 & 255) << 16)) | ((b1 & 255) << 8)) | (( (int)(( ::__hxcpp_memory_get_byte(data->buffer->b,(data->byteOffset + offset)) & 255)) ) & 255));
            			}
            			break;
            			case (int)2: {
HXLINE( 154)				int r2 = ( (int)(( ::__hxcpp_memory_get_byte(data->buffer->b,(data->byteOffset + (offset + 2))) & 255)) );
HXDLIN( 154)				int g2 = ( (int)(( ::__hxcpp_memory_get_byte(data->buffer->b,(data->byteOffset + (offset + 1))) & 255)) );
HXDLIN( 154)				int b2 = ( (int)(( ::__hxcpp_memory_get_byte(data->buffer->b,(data->byteOffset + offset)) & 255)) );
HXDLIN( 154)				this1 = (((((r2 & 255) << 24) | ((g2 & 255) << 16)) | ((b2 & 255) << 8)) | (( (int)(( ::__hxcpp_memory_get_byte(data->buffer->b,(data->byteOffset + (offset + 3))) & 255)) ) & 255));
            			}
            			break;
            		}
...
HXDLIN( 165)					int r3 = ( (int)(( ::__hxcpp_memory_get_byte(this2->buffer->b,(this2->byteOffset + ::Math_obj::round((( (Float)((hx::UShr(this1,24) & 255)) ) * ::lime::math::_RGBA::RGBA_Impl__obj::unmult)))) & 255)) );
HXDLIN( 165)					 ::lime::utils::ArrayBufferView this3 = ::lime::math::_RGBA::RGBA_Impl__obj::_hx___clamp;
HXDLIN( 165)					int g3 = ( (int)(( ::__hxcpp_memory_get_byte(this3->buffer->b,(this3->byteOffset + ::Math_obj::round((( (Float)((hx::UShr(this1,16) & 255)) ) * ::lime::math::_RGBA::RGBA_Impl__obj::unmult)))) & 255)) );
HXDLIN( 165)					 ::lime::utils::ArrayBufferView this4 = ::lime::math::_RGBA::RGBA_Impl__obj::_hx___clamp;
HXDLIN( 165)					this1 = (((((r3 & 255) << 24) | ((g3 & 255) << 16)) | ((( (int)(( ::__hxcpp_memory_get_byte(this4->buffer->b,(this4->byteOffset + ::Math_obj::round((( (Float)((hx::UShr(this1,8) & 255)) ) * ::lime::math::_RGBA::RGBA_Impl__obj::unmult)))) & 255)) ) & 255) << 8)) | ((this1 & 255) & 255));
            				}
            			}
            		}
            	}
...
HXDLIN( 219)					 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + 3)),val3);
            			...
            			case (int)1: {
HXLINE( 222)				{
HXLINE( 222)					int val4 = (this1 & 255);
HXDLIN( 222)					 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + offset),val4);
            				}
HXLINE( 223)				{
HXLINE( 223)					int val5 = (hx::UShr(this1,24) & 255);
HXDLIN( 223)					 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + 1)),val5);
            				}
HXLINE( 224)				{
HXLINE( 224)					int val6 = (hx::UShr(this1,16) & 255);
HXDLIN( 224)					 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + 2)),val6);
            				}
HXLINE( 225)				{
HXLINE( 225)					int val7 = (hx::UShr(this1,8) & 255);
HXDLIN( 225)					 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + 3)),val7);
            				}
            			}
            			break;
            			case (int)2: {
HXLINE( 210)				{
HXLINE( 210)					int val8 = (hx::UShr(this1,8) & 255);
HXDLIN( 210)					 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + offset),val8);
            				}
HXLINE( 211)				{
HXLINE( 211)					int val9 = (hx::UShr(this1,16) & 255);
HXDLIN( 211)					 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + 1)),val9);
            				}
HXLINE( 212)				{
HXLINE( 212)					int val10 = (hx::UShr(this1,24) & 255);
HXDLIN( 212)					 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + 2)),val10);
            				}
HXLINE( 213)				{
HXLINE( 213)					int val11 = (this1 & 255);
HXDLIN( 213)					 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + 3)),val11);
            				}
            			}
            			break;
            		}
