...
HXLINE( 685)				 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,6);
...
HXDLIN( 685)				if ((hx::Mod(in_byteOffset1,_this1->bytesPerElement) != 0)) {
HXLINE( 685)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
...
HXDLIN( 685)					if ((hx::Mod(bufferByteLength1,_this1->bytesPerElement) != 0)) {
HXLINE( 685)						HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            					}
