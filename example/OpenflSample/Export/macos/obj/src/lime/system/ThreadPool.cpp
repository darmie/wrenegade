...
HXLINE(  39)		this->_hx___workResult =  ::sys::thread::Deque_obj::__alloc( HX_CTX );
HXLINE(  37)		this->_hx___workIncoming =  ::sys::thread::Deque_obj::__alloc( HX_CTX );
...
HXLINE(  47)		this->currentThreads = 0;
HXLINE(  50)		this->_hx___workQueued = 0;
HXLINE(  51)		this->_hx___workCompleted = 0;
            	}
...
HXLINE(  76)			 ::sys::thread::Deque _hx_tmp2 = this->_hx___workIncoming;
...
HXLINE(  79)				_hx_tmp3 = (this->currentThreads < (this->_hx___workQueued - this->_hx___workCompleted));
            			}
            			else {
...
HXLINE(  82)				::sys::thread::Thread_obj::create(this->_hx___doWork_dyn());
            			}
...
HXLINE( 105)			 ::sys::thread::Deque _hx_tmp = this->_hx___workResult;
...
HXLINE( 118)			 ::sys::thread::Deque _hx_tmp = this->_hx___workResult;
...
HXLINE( 131)			 ::sys::thread::Deque _hx_tmp = this->_hx___workResult;
...
HXLINE( 144)			 ::sys::thread::Deque _hx_tmp = this->_hx___workResult;
...
void ThreadPool_obj::_hx___update(int deltaTime){
            	HX_GC_STACKFRAME(&_hx_pos_b98885ed80fb7e2e_174___update)
...
HXLINE( 180)				switch((int)(message->type->_hx_getIndex())){
            					case (int)0: case (int)1: {
HXLINE( 189)						this->_hx___workCompleted++;
HXLINE( 191)						bool _hx_tmp;
HXDLIN( 191)						bool _hx_tmp1;
HXDLIN( 191)						if ((this->currentThreads > (this->_hx___workQueued - this->_hx___workCompleted))) {
