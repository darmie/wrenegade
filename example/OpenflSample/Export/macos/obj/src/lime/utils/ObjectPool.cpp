...
HXLINE( 163)				if ((this->_hx___inactiveObjectList->length > 0)) {
HXLINE( 165)					this->_hx___inactiveObject0 = this->_hx___inactiveObjectList->pop();
            				}
HXLINE( 168)				if ((this->_hx___inactiveObjectList->length > 0)) {
...
HXDLIN( 186)		if ((count > 0)) {
HXLINE( 186)			_hx_tmp = (this->inactiveObjects == 0);
            		}
            		else {
...
HXLINE( 193)			count = (count - 1);
            		}
HXLINE( 196)		bool _hx_tmp1;
HXDLIN( 196)		if ((count != 0)) {
HXLINE( 196)			_hx_tmp1 = (this->inactiveObjects == 0);
            		}
            		else {
...
HXLINE( 203)			count = (count - 1);
            		}
HXLINE( 206)		bool _hx_tmp2;
HXDLIN( 206)		if ((count != 0)) {
HXLINE( 206)			_hx_tmp2 = (this->inactiveObjects == 0);
            		}
            		else {
...
HXLINE( 208)		{
HXLINE( 208)			 ::haxe::ds::_List::ListNode _g_head = this->_hx___inactiveObjectList->h;
...
HXLINE( 213)				count = (count - 1);
HXLINE( 215)				bool _hx_tmp3;
HXDLIN( 215)				if ((count != 0)) {
HXLINE( 215)					_hx_tmp3 = (this->inactiveObjects == 0);
            				}
            				else {
...
HXLINE( 238)				this->_hx___removeInactive((current - ( (int)(value) )));
            			}
            			else {
...
HXLINE( 244)					{
HXLINE( 244)						int _g = 0;
HXDLIN( 244)						int _g1 = (( (int)(value) ) - current);
