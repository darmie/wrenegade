...
static hx::StorageInfo Promise_lime_graphics_Image_obj_sMemberStorageInfo[] = {
	{hx::fsObject /*  ::lime::app::Future */ ,(int)offsetof(Promise_lime_graphics_Image_obj,future),HX_("future",43,98,4e,73)},
	{hx::fsBool,(int)offsetof(Promise_lime_graphics_Image_obj,isComplete),HX_("isComplete",c3,12,77,fa)},
	{hx::fsBool,(int)offsetof(Promise_lime_graphics_Image_obj,isError),HX_("isError",7e,6f,af,0f)},
	{ hx::fsUnknown, 0, null()}
};
...
{
	Promise_lime_graphics_Image_obj _hx_dummy;
	Promise_lime_graphics_Image_obj::_hx_vtable = *(void **)&_hx_dummy;
	hx::Static(__mClass) = new hx::Class_obj();
	__mClass->mName = HX_("lime.app.Promise_lime_graphics_Image",07,5c,99,9f);
