...
HX_LOCAL_STACK_FRAME(_hx_pos_8b63e6eaf513c097_48_get_length,"StringBuf","get_length",0xe673d2db,"StringBuf.get_length","/usr/local/lib/haxe/std/cpp/_std/StringBuf.hx",48,0x6c227dbe)
HX_LOCAL_STACK_FRAME(_hx_pos_8b63e6eaf513c097_87_toString,"StringBuf","toString",0x68f17bd8,"StringBuf.toString","/usr/local/lib/haxe/std/cpp/_std/StringBuf.hx",87,0x6c227dbe)
...
HXLINE(  37)		this->charBuf->push(0);
HXLINE(  38)		::cpp::Pointer< char > inPtr = ( (::cpp::Pointer< char >)(::cpp::Pointer_obj::arrayElem(this->charBuf,0)) );
...
::String StringBuf_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_8b63e6eaf513c097_87_toString)
HXLINE(  88)		if (hx::IsNotNull( this->charBuf )) {
HXLINE(  89)			this->flush();
            		}
HXLINE(  90)		bool _hx_tmp;
HXDLIN(  90)		if (hx::IsNotNull( this->b )) {
HXLINE(  90)			_hx_tmp = (this->b->length == 0);
            		}
            		else {
...
HXLINE(  92)		if ((this->b->length == 1)) {
HXLINE(  93)			return this->b->__get(0);
            		}
HXLINE(  94)		return this->b->join(HX_("",00,00,00,00));
            	}
