...
HXLINE(  39)		bool p = _hx_regexp_match(this->r,s,0,s.length);
HXLINE(  40)		if (p) {
...
HXDLIN(  64)		return _hx_regexp_matched_pos(this->r,0);
            	}
...
HXLINE(  84)			 ::Dynamic p = _hx_regexp_matched_pos(this->r,0);
HXLINE(  85)			bool _hx_tmp;
HXDLIN(  85)			if (hx::IsEq( p->__Field(HX_("len",d5,4b,52,00),hx::paccDynamic),0 )) {
...
HXLINE(  86)				if (hx::IsEq( p->__Field(HX_("pos",94,5d,55,00),hx::paccDynamic),s.length )) {
HXLINE(  87)					goto _hx_goto_5;
            				}
HXLINE(  88)				 ::Dynamic p1 = p;
HXDLIN(  88)				p1->__SetField(HX_("pos",94,5d,55,00),(p1->__Field(HX_("pos",94,5d,55,00),hx::paccDynamic) + 1),hx::paccDynamic);
            			}
HXLINE(  90)			a->push(s.substr(pos,(( (int)(p->__Field(HX_("pos",94,5d,55,00),hx::paccDynamic)) ) - pos)));
HXLINE(  91)			int tot = (( (int)((p->__Field(HX_("pos",94,5d,55,00),hx::paccDynamic) + p->__Field(HX_("len",d5,4b,52,00),hx::paccDynamic))) ) - pos);
...
HXLINE( 142)			int tot = (( (int)((p->__Field(HX_("pos",94,5d,55,00),hx::paccDynamic) + p->__Field(HX_("len",d5,4b,52,00),hx::paccDynamic))) ) - pos);
...
HXLINE( 161)			 ::Dynamic p = _hx_regexp_matched_pos(this->r,0);
HXLINE( 162)			{
...
HXLINE( 164)			if (hx::IsEq( p->__Field(HX_("len",d5,4b,52,00),hx::paccDynamic),0 )) {
HXLINE( 165)				{
HXLINE( 165)					::String x3 = s.substr(( (int)(p->__Field(HX_("pos",94,5d,55,00),hx::paccDynamic)) ),1);
...
HXLINE( 166)				offset = ( (int)((p->__Field(HX_("pos",94,5d,55,00),hx::paccDynamic) + 1)) );
            			}
            			else {
HXLINE( 169)				offset = ( (int)((p->__Field(HX_("pos",94,5d,55,00),hx::paccDynamic) + p->__Field(HX_("len",d5,4b,52,00),hx::paccDynamic))) );
            			}
