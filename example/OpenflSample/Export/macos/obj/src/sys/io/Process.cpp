...
HXLINE(  97)		if (( (bool)(detached) )) {
HXLINE(  97)			HX_STACK_DO_THROW(HX_("Detached process is not supported on this platform",8a,a6,56,0e));
            		}
HXLINE(  98)		 ::Dynamic _hx_tmp;
HXDLIN(  98)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE(  98)			_hx_tmp = _hx_std_process_run(cmd,args);
            		} catch( ::Dynamic _hx_e) {
            			if (_hx_e.IsClass<  ::Dynamic >() ){
            				HX_STACK_BEGIN_CATCH
            				 ::Dynamic e = _hx_e;
HXLINE(  98)				HX_STACK_DO_THROW((HX_("Process creation failure : ",cc,fa,44,a5) + cmd));
            			}
            			else {
            				HX_STACK_DO_THROW(_hx_e);
            			}
            		}
HXDLIN(  98)		this->p = _hx_tmp;
HXLINE(  99)		this->_hx_stdin =  ::sys::io::_Process::Stdin_obj::__alloc( HX_CTX ,this->p);
HXLINE( 100)		this->_hx_stdout =  ::sys::io::_Process::Stdout_obj::__alloc( HX_CTX ,this->p,true);
HXLINE( 101)		this->_hx_stderr =  ::sys::io::_Process::Stdout_obj::__alloc( HX_CTX ,this->p,false);
            	}
