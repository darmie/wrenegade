...
HXLINE(  29)		this->_hx___graphicsDataType = ::openfl::_internal::renderer::GraphicsDataType_obj::END_dyn();
HXLINE(  30)		this->_hx___graphicsFillType = ::openfl::_internal::renderer::GraphicsFillType_obj::END_FILL_dyn();
            	}
...
static hx::StorageInfo GraphicsEndFill_obj_sMemberStorageInfo[] = {
	{hx::fsObject /*  ::openfl::_internal::renderer::GraphicsDataType */ ,(int)offsetof(GraphicsEndFill_obj,_hx___graphicsDataType),HX_("__graphicsDataType",0f,5d,4d,46)},
	{hx::fsObject /*  ::openfl::_internal::renderer::GraphicsFillType */ ,(int)offsetof(GraphicsEndFill_obj,_hx___graphicsFillType),HX_("__graphicsFillType",e8,75,eb,27)},
	{ hx::fsUnknown, 0, null()}
};
