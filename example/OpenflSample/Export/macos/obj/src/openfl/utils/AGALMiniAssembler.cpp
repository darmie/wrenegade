...
HXLINE( 519)							::String _hx_tmp14 = ((((HX_("RELATIVE: type=",91,08,0e,50) + reltype) + HX_("==",60,35,00,00)) + relname->__get(0)) + HX_(" sel=",83,1b,23,b9));
HXDLIN( 519)							int int1 = relsel;
HXDLIN( 519)							Float _hx_tmp15;
HXDLIN( 519)							if ((int1 < 0)) {
...
HXDLIN( 519)							::String _hx_tmp17 = ((_hx_tmp16 + selmatch->__get(0)) + HX_(" idx=",80,41,86,b2));
HXDLIN( 519)							int int2 = regidx;
HXDLIN( 519)							Float _hx_tmp18;
HXDLIN( 519)							if ((int2 < 0)) {
...
HXLINE( 518)							::lime::utils::Log_obj::info(_hx_tmp19,hx::SourceInfo(HX_("openfl/utils/AGALMiniAssembler.hx",83,ff,5e,12),518,HX_("openfl.utils.AGALMiniAssembler",1d,f7,bb,62),HX_("assemble",12,a9,1b,c5)));
            						}
            					}
