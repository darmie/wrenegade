...
hx::Static(__mClass) = hx::_hx_RegisterClass(HX_("openfl._internal.renderer.context3D.Context3DElementType",9f,fa,59,bb), hx::TCanCast< Context3DElementType_obj >,Context3DElementType_obj_sStaticFields,0,
