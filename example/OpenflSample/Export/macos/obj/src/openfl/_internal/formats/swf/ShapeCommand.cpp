...
hx::Static(__mClass) = hx::_hx_RegisterClass(HX_("openfl._internal.formats.swf.ShapeCommand",78,32,71,a8), hx::TCanCast< ShapeCommand_obj >,ShapeCommand_obj_sStaticFields,0,
	&__Create_ShapeCommand_obj, &__Create,
	&super::__SGetClass(), &CreateShapeCommand_obj, 0
...
{
EndFill = hx::CreateConstEnum< ShapeCommand_obj >(HX_("EndFill",de,af,31,f3),4);
}
