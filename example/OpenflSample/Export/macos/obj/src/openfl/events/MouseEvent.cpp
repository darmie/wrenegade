...
static hx::StaticInfo MouseEvent_obj_sStaticStorageInfo[] = {
	{hx::fsObject /*  ::lime::utils::ObjectPool */ ,(void *) &MouseEvent_obj::_hx___pool,HX_("__pool",fc,e3,54,f9)},
...
HXDLIN(  26)		_hx___pool =  ::lime::utils::ObjectPool_obj::__alloc( HX_CTX ,null(),null(),20);
            	}
{
