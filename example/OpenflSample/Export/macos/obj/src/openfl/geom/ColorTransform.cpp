...
HXLINE( 246)		this->redMultiplier = ( (Float)(1) );
HXLINE( 247)		this->greenMultiplier = ( (Float)(1) );
HXLINE( 248)		this->blueMultiplier = ( (Float)(1) );
HXLINE( 249)		this->alphaMultiplier = ( (Float)(1) );
HXLINE( 250)		this->redOffset = ( (Float)(0) );
HXLINE( 251)		this->greenOffset = ( (Float)(0) );
HXLINE( 252)		this->blueOffset = ( (Float)(0) );
HXLINE( 253)		this->alphaOffset = ( (Float)(0) );
            	}
...
HXLINE( 258)		this->redMultiplier = (( (Float)(1) ) / this->redMultiplier);
HXLINE( 259)		this->greenMultiplier = (( (Float)(1) ) / this->greenMultiplier);
HXLINE( 260)		this->blueMultiplier = (( (Float)(1) ) / this->blueMultiplier);
HXLINE( 261)		this->alphaMultiplier = (( (Float)(1) ) / this->alphaMultiplier);
...
HXDLIN( 285)			if ((this->redMultiplier == 1)) {
HXLINE( 285)				_hx_tmp4 = (this->greenMultiplier == 1);
            			}
            			else {
HXLINE( 285)				_hx_tmp4 = false;
            			}
HXDLIN( 285)			if (_hx_tmp4) {
HXLINE( 285)				_hx_tmp3 = (this->blueMultiplier == 1);
            			}
            			else {
HXLINE( 285)				_hx_tmp3 = false;
            			}
HXDLIN( 285)			if (_hx_tmp3) {
HXLINE( 285)				_hx_tmp2 = (this->redOffset == 0);
            			}
            			else {
HXLINE( 285)				_hx_tmp2 = false;
            			}
HXDLIN( 285)			if (_hx_tmp2) {
HXLINE( 285)				_hx_tmp1 = (this->greenOffset == 0);
            			}
            			else {
HXLINE( 285)				_hx_tmp1 = false;
            			}
HXDLIN( 285)			if (_hx_tmp1) {
HXLINE( 285)				_hx_tmp = (this->blueOffset == 0);
            			}
            			else {
HXLINE( 285)				_hx_tmp = false;
            			}
HXDLIN( 285)			if (_hx_tmp) {
HXLINE( 291)				return (this->alphaOffset == 0);
            			}
            			else {
...
HXDLIN( 295)			if ((this->redMultiplier == 1)) {
HXLINE( 295)				_hx_tmp10 = (this->greenMultiplier == 1);
            			}
            			else {
HXLINE( 295)				_hx_tmp10 = false;
            			}
HXDLIN( 295)			if (_hx_tmp10) {
HXLINE( 295)				_hx_tmp9 = (this->blueMultiplier == 1);
            			}
            			else {
HXLINE( 295)				_hx_tmp9 = false;
            			}
HXDLIN( 295)			if (_hx_tmp9) {
HXLINE( 295)				_hx_tmp8 = (this->alphaMultiplier == 1);
            			}
            			else {
HXLINE( 295)				_hx_tmp8 = false;
            			}
HXDLIN( 295)			if (_hx_tmp8) {
HXLINE( 295)				_hx_tmp7 = (this->redOffset == 0);
            			}
            			else {
HXLINE( 295)				_hx_tmp7 = false;
            			}
HXDLIN( 295)			if (_hx_tmp7) {
HXLINE( 295)				_hx_tmp6 = (this->greenOffset == 0);
            			}
            			else {
HXLINE( 295)				_hx_tmp6 = false;
            			}
HXDLIN( 295)			if (_hx_tmp6) {
HXLINE( 295)				_hx_tmp5 = (this->blueOffset == 0);
            			}
            			else {
HXLINE( 295)				_hx_tmp5 = false;
            			}
HXDLIN( 295)			if (_hx_tmp5) {
HXLINE( 296)				return (this->alphaOffset == 0);
            			}
            			else {
...
HXLINE( 302)		colorMultipliers[0] = this->redMultiplier;
HXLINE( 303)		colorMultipliers[1] = this->greenMultiplier;
HXLINE( 304)		colorMultipliers[2] = this->blueMultiplier;
HXLINE( 305)		colorMultipliers[3] = this->alphaMultiplier;
HXLINE( 306)		colorOffsets[0] = this->redOffset;
HXLINE( 307)		colorOffsets[1] = this->greenOffset;
HXLINE( 308)		colorOffsets[2] = this->blueOffset;
HXLINE( 309)		colorOffsets[3] = this->alphaOffset;
            	}
...
HXDLIN( 315)		int _hx_tmp = (::Std_obj::_hx_int(this->redOffset) << 16);
HXDLIN( 315)		int _hx_tmp1 = (_hx_tmp | (::Std_obj::_hx_int(this->greenOffset) << 8));
HXDLIN( 315)		return (_hx_tmp1 | ::Std_obj::_hx_int(this->blueOffset));
            	}
...
HXLINE( 320)		this->redOffset = ( (Float)(((value >> 16) & 255)) );
HXLINE( 321)		this->greenOffset = ( (Float)(((value >> 8) & 255)) );
HXLINE( 322)		this->blueOffset = ( (Float)((value & 255)) );
HXLINE( 324)		this->redMultiplier = ( (Float)(0) );
HXLINE( 325)		this->greenMultiplier = ( (Float)(0) );
HXLINE( 326)		this->blueMultiplier = ( (Float)(0) );
...
HXLINE( 336)			 ::lime::utils::ArrayBufferView this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,20,8);
...
HXDLIN( 340)			Float val1 = (this->redOffset / ( (Float)(255) ));
HXDLIN( 340)			 ::__hxcpp_memory_set_float(this3->buffer->b,(this3->byteOffset + 16),val1);
            		}
HXLINE( 341)		{
...
HXDLIN( 341)			 ::__hxcpp_memory_set_float(this4->buffer->b,(this4->byteOffset + 24),val2);
            		}
HXLINE( 342)		{
HXLINE( 342)			 ::lime::utils::ArrayBufferView this5 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 342)			Float val3 = (this->greenOffset / ( (Float)(255) ));
HXDLIN( 342)			 ::__hxcpp_memory_set_float(this5->buffer->b,(this5->byteOffset + 36),val3);
            		}
HXLINE( 343)		{
...
HXDLIN( 343)			 ::__hxcpp_memory_set_float(this6->buffer->b,(this6->byteOffset + 48),val4);
            		}
HXLINE( 344)		{
HXLINE( 344)			 ::lime::utils::ArrayBufferView this7 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 344)			Float val5 = (this->blueOffset / ( (Float)(255) ));
HXDLIN( 344)			 ::__hxcpp_memory_set_float(this7->buffer->b,(this7->byteOffset + 56),val5);
            		}
HXLINE( 345)		{
...
HXDLIN( 345)			 ::__hxcpp_memory_set_float(this8->buffer->b,(this8->byteOffset + 72),val6);
            		}
HXLINE( 346)		{
HXLINE( 346)			 ::lime::utils::ArrayBufferView this9 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 346)			Float val7 = (this->alphaOffset / ( (Float)(255) ));
HXDLIN( 346)			 ::__hxcpp_memory_set_float(this9->buffer->b,(this9->byteOffset + 76),val7);
            		}
