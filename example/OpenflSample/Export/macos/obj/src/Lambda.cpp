...
HX_LOCAL_STACK_FRAME(_hx_pos_a2b9229e56451ffa_47_array,"Lambda","array",0x9c8b0512,"Lambda.array","/usr/local/lib/haxe/std/Lambda.hx",47,0xf61dfe9a)
...
::cpp::VirtualArray Lambda_obj::array( ::Dynamic it){
            	HX_STACKFRAME(&_hx_pos_a2b9229e56451ffa_47_array)
...
HXDLIN(  49)			while(( (bool)(i->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE(  49)				 ::Dynamic i1 = i->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)();
HXLINE(  50)				a->push(i1);
            			}
            		}
HXLINE(  51)		return a;
